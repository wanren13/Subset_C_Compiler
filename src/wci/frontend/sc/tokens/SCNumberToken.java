...
import static wci.frontend.sc.SCErrorCode.INVALID_NUMBER;
import static wci.frontend.sc.SCErrorCode.RANGE_INTEGER;
import static wci.frontend.sc.SCErrorCode.RANGE_REAL;
import static wci.frontend.sc.SCTokenType.ERROR;
import static wci.frontend.sc.SCTokenType.INTEGER;
import static wci.frontend.sc.SCTokenType.REAL;
import wci.frontend.Source;
import wci.frontend.sc.SCToken;

public class SCNumberToken extends SCToken {
     ...
     */
    public SCNumberToken(Source source)
        throws Exception
    {
        super(source);
    }
